...
<div class="row">
<div class="col-lg-6">
<span class="logo">EcoSmart Exams</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>EcoSmart Developer</b></a>
    </div>
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$g.'</td><td>'.$coll.'</td><td>'.$s.'</td><td>';
}
echo '</table></div>';}
?>
...
<a href="#" data-toggle="modal" data-target="#Admin login">Admin Login</a></div>
<div class="col-md-4 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/1.jpg" width=100 height=100 alt="Prince Yadav" class="img-circle">
      <img src="image/2.jpg" width=100 height=100 alt="Krishnadev Thakur" class="img-circle">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Prince Yadav & Krishnadev Thakur</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8451868265 /8355965177</h4>
		<h4 style="font-family:'typo' ">iamzero759@gmail.com/ahero@gmail.com</h4>
