...
<div class="col-lg-6">
<span class="logo">EcoSmart</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:iamkrishnadev1999@gmail.com" style="color:#000000">Mail Me</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/1.jpg" width=100 height=100 alt="Prince Yadav" class="img-rounded">
     <img src="image/2.jpg" width=100 height=100 alt="Krishnadev Thakur" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Prince and Krishnadev</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8451868265 / 8355965177</h4>
		<h4 style="font-family:'typo' ">iamgod759@gmail.com</h4>
